      ...
      <div className="container px-6 max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              We don't just talk about growth, we deliver it. Here's proof from actual client campaigns.
            </p>
          </div>
          ...
          <p className="text-sm text-muted-foreground">
            These are actual analytics from our client campaigns showing sustainable, data-driven growth.
          </p>
        </div>
      </div>
    </section>
